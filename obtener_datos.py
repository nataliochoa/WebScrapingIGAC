...
carpeta_destino = 'C:/Users/NATALI OCHOA/Desktop/PASANTIA IGAC/data/venta_barranquilla.json' 

#abre la carpeta de destino con permiso para escribir (write)

f = open(carpeta_destino, 'w')
...
#context tiene funciones de busqueda

def urlcaida(context, url): 
    try:
    ...
    try:   
        ...
        try:  
            ...
            if urlcaida(body,url) is False and is_new(body) is False:           
                ...
                #se crea diccionario para guardar las variables
